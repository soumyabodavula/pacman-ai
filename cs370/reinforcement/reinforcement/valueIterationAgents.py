...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        for i in range(self.iterations):
            ...
            for s in states:
                a = self.getAction(s)
                if a is not None:
                    temp_values[s] = self.getQValue(s, a)
    ...
    def computeQValueFromValues(self, state, action):
        ...
        value = 0
        next_s_p = self.mdp.getTransitionStatesAndProbs(state, action) #(nextState, prob)
        for (nextState, prob) in next_s_p:
    ...
    def computeActionFromValues(self, state):
        ...
        max_value = self.getQValue(state, poss_actions[0])
